...
//
// The crowd is the interesting case. Tens of thousands of zombies die per wave, so
...
export const sfx = {
  ...
  // Called every frame with how many zombies died. Deaths are a texture, not events.
