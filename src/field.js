...
export class Field {
  ...
  // Turrets are built ON the rock, on the plateaus above the trenches the zombies
  ...
  #bakeFlow() {
    ...
    for (let y = 0; y < h; y++) {
      for (let x = 0; x < w; x++) {
        ...
        // result was a dead ring around the base where arriving zombies stopped just
